...
const OrderSummary = () => {
		...
		try {
			...
			const options = {
				...
				prefill: {
					...
					email: "customer@example.com", // You can get this from user store
				},
				theme: {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-blue-700 bg-gray-800 p-4 shadow-sm sm:p-6'
		...
		>
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					...
					<dl className='flex items-center justify-between gap-4 border-t border-blue-600 pt-2'>
						<dt className='text-base font-bold text-blue-400'>Total</dt>

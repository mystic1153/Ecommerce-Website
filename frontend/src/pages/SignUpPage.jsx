...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-blue-800'>
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-blue-600 rounded-md shadow-sm
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border border-blue-600 
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border
									 border-blue-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>

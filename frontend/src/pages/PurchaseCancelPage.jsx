			...
			>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<Link
							to={"/"}
							className='w-full bg-gray-700 hover:bg-gray-600 text-emerald-300 font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center'
						>
